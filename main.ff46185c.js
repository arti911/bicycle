...
},{"dom7/dist/dom7.modular":"../../node_modules/dom7/dist/dom7.modular.js","ssr-window":"../../node_modules/ssr-window/dist/ssr-window.esm.js"}],"../blocks/twitter/index.js":[function(require,module,exports) {
"use strict";
...
var initSlider = function initSlider() {
  return new _swiper.default('.swiper-container', {
    pagination: {
...
exports.default = _default;
},{"swiper":"../../node_modules/swiper/js/swiper.esm.bundle.js"}],"../scripts/scrollSection.js":[function(require,module,exports) {
"use strict";
...
var scrolling = function scrolling() {
  menuBtn.forEach(function (btn) {
    btn.addEventListener('click', function () {
      var index = findSection(btn.getAttribute('id'));
...
exports.default = _default;
},{}],"../scripts/isBgNavigation.js":[function(require,module,exports) {
"use strict";
...
var _isBgNavigation = _interopRequireDefault(require("./isBgNavigation"));
...
var _default = function _default() {
  ...
  document.addEventListener('scroll', function () {
    if (currentScroll < window.pageYOffset) {
      parallax.style.transform = "scale(".concat(tScale += 0.002, ")");
    } else {
      tScale = tScale.toFixed(3) - 0.002;

      if (tScale < 1 || window.pageYOffset === 0) {
        tScale = 1;
        parallax.style.transform = "scale(".concat(tScale, ")");
      } else {
        parallax.style.transform = "scale(".concat(tScale = tScale, ")");
      }
    }

    (0, _isBgNavigation.default)();
...
},{"_css_loader":"C:/Users/hafud/AppData/Roaming/npm/node_modules/parcel-bundler/src/builtins/css-loader.js"}],"../main.scss":[function(require,module,exports) {
var reloadCSS = require('_css_loader');

module.hot.dispose(reloadCSS);
module.hot.accept(reloadCSS);
},{"./assets\\images\\top.jpg":[["top.71e10213.jpg","../assets/images/top.jpg"],"../assets/images/top.jpg"],"_css_loader":"C:/Users/hafud/AppData/Roaming/npm/node_modules/parcel-bundler/src/builtins/css-loader.js"}],"../main.js":[function(require,module,exports) {
"use strict";

var _index = _interopRequireDefault(require("./blocks/twitter/index"));

var _scrollSection = _interopRequireDefault(require("./scripts/scrollSection"));
